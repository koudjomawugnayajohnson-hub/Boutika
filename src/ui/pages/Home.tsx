      ...
      <main className="w-full max-w-container-max mx-auto px-lg md:px-xl py-xl flex flex-col md:flex-row items-center justify-between z-10 gap-xl relative">
        ...
        <div className="hidden sm:block flex-1 w-full max-w-xl relative mt-8 md:mt-0">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border border-outline-variant aspect-video bg-surface-container relative group">
            <img className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" alt="Un professionnel utilisant Boutika" src="/hero-boutika.png" fetchPriority="high" />
